    ...
    <div class="card mb-4 w-95">
      <div class="card-header pb-0 d-flex justify-content-between">
        ...
        <div class="Ajouter-Client">
                <a  href="/Fournisseur/Ajouter" id="search-button" type="button" class="btn btn-success h-75 ms-5">
          ...
          <table class="table align-items-center mb-0">
            <thead>
                <tr>
                    ...
                    <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Nom complet de Fournisseur</th>
            ...
            <tbody>
              <tr>
                ...
                <td class="align-middle text-center cursor-pointe">
                  <a href="/Fournisseur/Modifier" class="text-secondary font-weight-bold text-xs px-2 px-2" role="button">
                    Modifier
                  </a>
